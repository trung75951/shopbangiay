...
// if(isset($_POST['tmpArray']))
// {
//     $tmpArray = explode(',',$_POST['tmpArray']);
//     $hh=new HangHoa();
//     $results=$hh->getListHangHoaByTypes($tmpArray);
//     while ($set=$results->fetch()) {
//         echo $set['tenhh'];
//     }
// }
// echo '<script>alert("'.$ac.'")</script>';
$arrMaloai = explode(',',$_POST['filter']);
$hh = new HangHoa();
$results = $hh->getFilterMaloai1($arrMaloai);
// $results = $hh->getFilterMaloai();
