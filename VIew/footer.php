<footer class="bg-dark site-footer navbar-static-bottom " style="margin-top: 115px;">
      <div class="container p-4 bg-dark">
          ...
          <hr class="bg-white">
          <div class="row">
              <div class="col-lg-6" style="color: wheat;">Copyright &copy; 2021 by ITC</div>
              <div class="col-lg-6 text-right" style="color: wheat;">
