...
if ($hienthi == "viewh" || $hienthi =="macdinh") {
    $results = $hh->getListHangHoaView();
}
elseif($hienthi == "increased"){
    $results = $hh->getListHangHoaIncrea();
}
elseif($hienthi == "decreased"){
    $results = $hh->getListHangHoaDecrea();
